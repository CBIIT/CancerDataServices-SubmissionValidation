...
# TODO: add warning for important (vs required) fields
#required_input_fields = ["file_name", "file_size", "md5sum"]
required_input_fields = ["file_name", "md5sum"]
...
class Subfile:
    ...
    def validate_all_required_fields_are_present(self):
        ...
        for reqd_field in required_input_fields:
            ...
            # I'm converting field to string in case input is number/int before stripping all /w
